...
- Clone your application's code repository onto the EC2 instance:
    ...
    ```bash
    git clone https://github.com/Mauliksha/Netflix_DevSecOps-Project.git
    ```
...
pipeline{
    ...
    stages {
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag netflix maulikshah951995875/netflix:latest "
                       sh "docker push maulikshah951995875/netflix:latest "
                    }
                }
            }
        }
        stage("TRIVY"){
            steps{
                sh "trivy image maulikshah951995875/netflix:latest > trivyimage.txt" 
            }
        }
        stage('Deploy to container'){
            steps{
                sh 'docker run -d --name netflix -p 8081:80 maulikshah951995875/netflix:latest'
            }
        }
    }
}
